...
if (!isExistInputTemplate($_SESSION['user_groups_id'], $template_id)) {
...
if (isset($_POST['entry'])) {
    ...
    $post_member_id = $_POST['member'];
    $post_category_id = $_POST['category'];
    $post_type_no = $_POST['type'];
    $post_payment_no = $_POST['payment'];
    $post_settlement_no = $_POST['settlement'];
    $post_amount = $_POST['amount'];
    $post_remarks = $_POST['remarks'] ?? '';
    $post_use = $_POST['use'] ?? '';
    $post_status = $_POST['status'] ?? '';

    $result = inputTemplatePostActionForUpdateEvent(
    ...
    if ($data['status'] != 'error') {
        createLogs(LOG_TYPE_INFO, UI_ITEM_INPUT_TEMPLATE . "更新 - " . UI_ITEM_INPUT_TEMPLATE . "更新");
    } else {
        $entry_error = true;
        createLogs(LOG_TYPE_ERROR, UI_ITEM_INPUT_TEMPLATE . "更新 - " . UI_ITEM_INPUT_TEMPLATE . "更新失敗");
    }
}
...
$template_data = getInputTemplate($_SESSION['user_groups_id'], $template_id);
...
$template_amount = $template_data['amount'];
    ...
    <div class="btn-area">
        <div class="btn-center-area">
            <div class='btn-item'><a class='link-btn'
                                     href='/Interfaces/Views/Pages/user/group/setting/template/input_template/user_group_input_template_list.php'><?php echo UI_ITEM_INPUT_TEMPLATE; ?>
                    一覧</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="form-area">
                        ...
                        <div class="form-item">
                            <div class="form-item-label">
                                <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE; ?>ID</label>
                            </div>
                        ...
                        <div class="form-item">
                            <div class="form-item-label">
                                <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_NO; ?></label>
                            </div>
                            <div class="input-group form-item" style="display: none">
                        ...
                        <div class="form-item">
                            <div class="form-item-label">
                                <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_NAME; ?></label>
                            </div>
                            <div class="input-group form-item">
                        ...
                        <div class="form-item member-item">
                            <div class="form-item-label">
                                <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_MEMBER; ?></label>
                            </div>
                            <div class="input-group form-item">
                        ...
                        <div class="pc-form">
                            ...
                            <div class="form-item category-item">
                                <div class="form-item-label">
                                    <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_CATEGORY; ?></label>
                                </div>
                                <div class="input-group form-item">
                            ...
                            <div class="form-item type-item">
                                <div class="form-item-label">
                                    <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_TYPE; ?></label>
                                </div>
                                <div class="input-group form-item">
                            ...
                            <div class="form-item payment-item">
                                <div class="form-item-label">
                                    <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_PAYMENT; ?></label>
                                </div>
                                <div class="input-group form-item">
                            ...
                            <div class="form-item settlement-item">
                                <div class="form-item-label">
                                    <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_SETTLEMENT; ?></label>
                                </div>
                                <div class="input-group form-item">
                        ...
                        <div class="pc-form">
                            ...
                            <div class="form-item amount-item">
                                <div class="form-item-label">
                                    <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_AMOUNT; ?></label>
                                </div>
                                <div class="input-group form-item">
                                    <input required type="number" min="1" class="form-control" name="amount"
                                        <?php echo "value='{$template_amount}'"; ?>
                                    >
                                </div>
                            </div>
                            ...
                            <div class="form-item remarks-item">
                                <div class="form-item-label">
                                    <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_REMARKS; ?></label>
                                </div>
                                <div class="input-group form-item">
                        ...
                        <div class="form-item">
                            <div class="form-item-label">
                                <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_USE; ?></label>
                            </div>
                        ...
                        <div class="form-item">
                            <div class="form-item-label">
                                <label class="item-label"><?php echo UI_ITEM_INPUT_TEMPLATE_STATUS; ?></label>
                            </div>
                            <div class="form-check">
