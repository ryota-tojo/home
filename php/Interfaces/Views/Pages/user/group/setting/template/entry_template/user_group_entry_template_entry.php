...
if (isset($_POST['entry'])) {
    ...
    $result = entryTemplatePostActionForEntryEvent(
    ...
    if ($data['status'] != 'error') {
        createLogs(LOG_TYPE_INFO, UI_ITEM_ENTRY_TEMPLATE . "登録 - " . UI_ITEM_ENTRY_TEMPLATE . "登録");
    } else {
        $entry_error = true;
        createLogs(LOG_TYPE_ERROR, UI_ITEM_ENTRY_TEMPLATE . "登録 - " . UI_ITEM_ENTRY_TEMPLATE . "登録失敗");
    }
}
