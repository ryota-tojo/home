...
class ShoppingInputTemplateService(
    ...
    fun usage(
        ...
        val updateRows = shoppingInputTemplateRepository.usage(groupsId, templateId)
        return ShoppingInputTemplateUpdateResult(
            ResponseCode.成功.code,
            updateRows
        )
    ...
    fun unUsage(
        ...
        val updateRows = shoppingInputTemplateRepository.unUsage(groupsId, templateId)
        return ShoppingInputTemplateUpdateResult(
            ResponseCode.成功.code,
            updateRows
        )
    ...
    fun setDeleted(
        ...
        val updateRows = shoppingInputTemplateRepository.setDeleted(groupsId, templateId)
        if (updateRows == 0) {
            return ShoppingInputTemplateUpdateResult(
                ResponseCode.データ不在エラー.code,
                updateRows
    ...
    fun setUnDeleted(
        ...
        val updateRows = shoppingInputTemplateRepository.setUnDeleted(groupsId, templateId)
        if (updateRows == 0) {
            return ShoppingInputTemplateUpdateResult(
                ResponseCode.データ不在エラー.code,
                updateRows
