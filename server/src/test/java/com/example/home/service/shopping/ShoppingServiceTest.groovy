...
class ShoppingServiceTest extends Specification {
    ...
    def "shopping_refer_#useCase"() {
        ...
        where:
        useCase                                | expected                                                                             | shoppingList                        | id                            | groupsId                               | shoppingDateYYYY     | shoppingDateMM       | memberId                        | categoryId                          | type                            | payment                           | settlement                        | minAmount              | maxAmount              | remarks
        "正常_idあり_groupsIdあり"             | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | FixtureEtc.年_正常() | FixtureEtc.月_正常() | FixtureMember.メンバーID_正常() | FixtureCategory.カテゴリーID_正常() | FixtureShopping.購入種別_出費() | FixtureShopping.支払い方法_現金() | FixtureShopping.精算状態_未精算() | FixtureEtc.金額_正常() | FixtureEtc.金額_正常() | FixtureShopping.備考_正常()
        "正常_idなし_groupsIdあり"             | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | null                          | FixtureGroupList.所属グループID_正常() | FixtureEtc.年_正常() | FixtureEtc.月_正常() | FixtureMember.メンバーID_正常() | FixtureCategory.カテゴリーID_正常() | FixtureShopping.購入種別_出費() | FixtureShopping.支払い方法_現金() | FixtureShopping.精算状態_未精算() | FixtureEtc.金額_正常() | FixtureEtc.金額_正常() | FixtureShopping.備考_正常()
        "正常_idなし_groupsIdなし"             | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | null                          | null                                   | FixtureEtc.年_正常() | FixtureEtc.月_正常() | FixtureMember.メンバーID_正常() | FixtureCategory.カテゴリーID_正常() | FixtureShopping.購入種別_出費() | FixtureShopping.支払い方法_現金() | FixtureShopping.精算状態_未精算() | FixtureEtc.金額_正常() | FixtureEtc.金額_正常() | FixtureShopping.備考_正常()
        "正常_年月"                            | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | null                                | null                            | null                              | null                              | null                   | null                   | null
        "正常_年月 + メンバー番号"             | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | FixtureEtc.年_正常() | FixtureEtc.月_正常() | FixtureMember.メンバーID_正常() | null                                | null                            | null                              | null                              | null                   | null                   | null
        "正常_年月 + カテゴリー番号"           | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | FixtureCategory.カテゴリーID_正常() | null                            | null                              | null                              | null                   | null                   | null
        "正常_メンバー番号 + 買い物種別"       | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | null                 | null                 | FixtureMember.メンバーID_正常() | null                                | FixtureShopping.購入種別_出費() | null                              | null                              | null                   | null                   | null
        "正常_カテゴリー番号 + 支払い方法"     | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | null                 | null                 | null                            | FixtureCategory.カテゴリーID_正常() | null                            | FixtureShopping.支払い方法_現金() | null                              | null                   | null                   | null
        "正常_年月 + 精算状態"                 | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | null                                | null                            | null                              | FixtureShopping.精算状態_未精算() | null                   | null                   | null
        "正常_年月 + 最小金額"                 | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | null                                | null                            | null                              | null                              | FixtureEtc.金額_正常() | null                   | null
        "正常_年月 + 最大金額"                 | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | null                                | null                            | null                              | null                              | null                   | FixtureEtc.金額_正常() | null
        "正常_年月 + 最小金額 + 最大金額"      | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | null                                | null                            | null                              | null                              | FixtureEtc.金額_正常() | FixtureEtc.金額_正常() | null
        "メンバー番号 + カテゴリー番号 + 備考" | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | null                 | null                 | FixtureMember.メンバーID_正常() | FixtureCategory.カテゴリーID_正常() | null                            | null                              | null                              | null                   | null                   | FixtureShopping.備考_正常()
        "正常_データなし" | new ShoppingReferResult(ResponseCode.データ不在エラー.code, null) | null | FixtureShopping.購入ID_正常() | FixtureGroupList.所属グループID_正常() | FixtureEtc.年_正常() | FixtureEtc.月_正常() | FixtureMember.メンバーID_正常() | FixtureCategory.カテゴリーID_正常() | FixtureShopping.購入種別_出費() | FixtureShopping.支払い方法_現金() | FixtureShopping.精算状態_未精算() | FixtureEtc.金額_正常() | FixtureEtc.金額_正常() | FixtureShopping.備考_正常()
    }
    ...
    def "shopping_save_#useCase"() {
        ...
        when:
        def result = sut.save(groupsId, userId, shoppingDate, memberId, categoryId, type, payment, settlement, amount, remarks
        )
        ...
        saveCnt * shoppingRepository.save(groupsId, userId, shoppingDate, memberId, categoryId, type, payment, settlement, amount, remarks
        ) >> shopping
        result == expected
        ...
        "正常"                | new ShoppingSaveResult(ResponseCode.成功.code, FixtureShopping.購入データ_正常()) | FixtureShopping.購入データ_正常() | [FixtureMember.メンバー_正常値()] | [FixtureCategory.カテゴリー_正常値()] | GroovyMock(MasterChoices) | GroovyMock(MasterChoices) | GroovyMock(MasterChoices) | 1           | 1          | 1          | 1          | 1
    ...
    def "shopping_isDuplication_#useCase"() {
        ...
        when:
        def result = sut.isDuplication(groupsId, shoppingDate, memberId, categoryId, type, payment, settlement, amount, remarks
        )

        then:
        1 * shoppingRepository.isDuplication(groupsId, shoppingDate, memberId, categoryId, type, payment, settlement, amount, remarks
        ) >> duplication
        result == expected
    ...
    def "shopping_update_#useCase"() {
        ...
        setup:
        def shoppingId = FixtureShopping.購入ID_正常()
        def groupsId = FixtureGroupList.所属グループID_正常()
        def userId = FixtureUserInfo.ユーザーID_正常()
        def shoppingDate = FixtureShopping.購入日_正常()
        def memberId = FixtureMember.メンバーID_正常()
        ...
        when:
        def result = sut.update(shoppingId, groupsId, userId, shoppingDate, memberId, categoryId, type, payment, settlement, amount, remarks, fixedFlg
        )
        ...
        choiceCnt2 * choicesRepository.getItemName(FixtureChoices.選択肢_支払い方法(), _) >> masterCoices2
        choiceCnt3 * choicesRepository.getItemName(FixtureChoices.選択肢_精算状況(), _) >> masterCoices3
        updateCnt * shoppingRepository.update(shoppingId, groupsId, userId, shoppingDate, memberId, categoryId, type, payment, settlement, amount, remarks, fixedFlg
        ) >> updateRows
        result == expected
