...
class ShoppingServiceTest extends Specification {
    ...
    def "shopping_refer_#useCase"() {
        ...
        when:
        def result = sut.refer(groupsId, userId, shoppingDateYYYY, shoppingDateMM, memberId, categoryId, type, payment, settlement, minAmount, maxAmount, remarks
        )

        then:
        1 * shoppingRepository.refer(groupsId, userId, shoppingDateYYYY, shoppingDateMM, memberId, categoryId, type, payment, settlement, minAmount, maxAmount, remarks
        ) >> shoppingList
        result == expected

        where:
        useCase                                | expected                                                                             | shoppingList                        | shoppingDateYYYY     | shoppingDateMM       | memberId                        | categoryId                          | type                            | payment                           | settlement                        | minAmount              | maxAmount              | remarks
        "正常_All"                             | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureEtc.年_正常() | FixtureEtc.月_正常() | FixtureMember.メンバーID_正常() | FixtureCategory.カテゴリーID_正常() | FixtureShopping.購入種別_出費() | FixtureShopping.支払い方法_現金() | FixtureShopping.精算状態_未精算() | FixtureEtc.金額_正常() | FixtureEtc.金額_正常() | FixtureShopping.備考_正常()
        "正常_年月"                            | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | null                                | null                            | null                              | null                              | null                   | null                   | null
        "正常_年月 + メンバー番号"             | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureEtc.年_正常() | FixtureEtc.月_正常() | FixtureMember.メンバーID_正常() | null                                | null                            | null                              | null                              | null                   | null                   | null
        "正常_年月 + カテゴリー番号"           | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | FixtureCategory.カテゴリーID_正常() | null                            | null                              | null                              | null                   | null                   | null
        "正常_メンバー番号 + 買い物種別"       | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | null                 | null                 | FixtureMember.メンバーID_正常() | null                                | FixtureShopping.購入種別_出費() | null                              | null                              | null                   | null                   | null
        "正常_カテゴリー番号 + 支払い方法"     | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | null                 | null                 | null                            | FixtureCategory.カテゴリーID_正常() | null                            | FixtureShopping.支払い方法_現金() | null                              | null                   | null                   | null
        "正常_年月 + 精算状態"                 | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | null                                | null                            | null                              | FixtureShopping.精算状態_未精算() | null                   | null                   | null
        "正常_年月 + 最小金額"                 | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | null                                | null                            | null                              | null                              | FixtureEtc.金額_正常() | null                   | null
        "正常_年月 + 最大金額"                 | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | null                                | null                            | null                              | null                              | null                   | FixtureEtc.金額_正常() | null
        "正常_年月 + 最小金額 + 最大金額"      | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | FixtureEtc.年_正常() | FixtureEtc.月_正常() | null                            | null                                | null                            | null                              | null                              | FixtureEtc.金額_正常() | FixtureEtc.金額_正常() | null
        "メンバー番号 + カテゴリー番号 + 備考" | new ShoppingReferResult(ResponseCode.成功.code, [FixtureShopping.購入データ_正常()]) | [FixtureShopping.購入データ_正常()] | null                 | null                 | FixtureMember.メンバーID_正常() | FixtureCategory.カテゴリーID_正常() | null                            | null                              | null                              | null                   | null                   | FixtureShopping.備考_正常()
        "正常_データなし"                      | new ShoppingReferResult(ResponseCode.成功.code, null)                                | null                                | FixtureEtc.年_正常() | FixtureEtc.月_正常() | FixtureMember.メンバーID_正常() | FixtureCategory.カテゴリーID_正常() | FixtureShopping.購入種別_出費() | FixtureShopping.支払い方法_現金() | FixtureShopping.精算状態_未精算() | FixtureEtc.金額_正常() | FixtureEtc.金額_正常() | FixtureShopping.備考_正常()
    }
