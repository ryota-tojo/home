...
class MasterSettingServiceTest extends Specification {
    ...
    def "master_save_#useCase"() {
        ...
        "正常" | new MasterSettingSaveResult(ResponseCode.成功.code, FixtureMasterSetting.マスター設定_正常()) | FixtureMasterSetting.マスター設定キー_正常() | FixtureMasterSetting.マスター設定値_正常() | FixtureMasterSetting.マスター設定備考_正常() | [] | FixtureMasterSetting.マスター設定_正常() | 1 | 1
